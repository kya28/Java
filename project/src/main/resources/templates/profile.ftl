            ...
            <header class="shop-header">
                ...
                <form method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="${user.firstName}"  name="firstName" placeholder="Имя" size="20">
                    </div>
                    <div class="form-group">
                        <label for="user_login">Фамилия</label>
                        <input type="text" class="form-control"  value="${user.lastName}"  name="lastName" placeholder="Фамилия" size="20">
                    </div>
                    <div class="form-group">
                        <label for="user_login">Возраст</label>
                        <input type="text" class="form-control"  name="age" placeholder="Возраст" size="20">
                    </div>
                    <div class="form-group">
                        <label for="user_pass">Ваша почта</label>
                        <input type="email" class="form-control" name="email" placeholder="Почта" size="20">
                    </div>
                    <input type="submit" class="sorting-btn  block_center" value="Сохранить">
                </form>
            </div>
        </div>
        <a href="basket">Просмотреть корзину</a>
    </main>
