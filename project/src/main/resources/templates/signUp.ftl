        ...
        <div class="center center-content">
            ...
            <form method="post">
             <div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="firstName" placeholder="Имя" size="20">
                           </div>

                <div class="form-group">
                        <label for="user_login">Фамилия</label>
                         <input type="text" class="form-control"  name="lastName" placeholder="Фамилия" size="20">
                                               </div>
                ...
                <input type="submit" class="sorting-btn  block_center" value="Регистрация">
                <a href="signIn" class="sorting-btn  block_center" >Я уже зарегистрирован</a>
            </form>
                </div>
